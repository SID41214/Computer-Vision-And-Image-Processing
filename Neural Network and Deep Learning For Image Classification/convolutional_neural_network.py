...
Original file is located at
    https://colab.research.google.com/drive/1RnenHnZPCzAq9QedOod_ByVRDjdUhpd-
...
we will use a Convolutional Neural Network to classify handwritten digits from the MNIST database. We will reshape the images to make them faster to process
...
"""Load the testing dataset by setting the parameter train to False."""

validation_dataset = dsets.MNIST(root='./data', train=False, download=True, transform=composed)

"""Each element in the rectangular tensor corresponds to a number representing a pixel intensity as demonstrated by the following imag
